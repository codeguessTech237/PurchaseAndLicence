...
@section('content')
    ...
    <div class="text-center text-white mb-4">
        <h2>Codeguess Software Installation</h2>
        <h6 class="fw-normal">Please proceed step by step with proper data according to instructions</h6>
    </div>

    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Codeguess Software Installation"
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            <div class="d-flex justify-content-end mb-2">
                <a href="https://codeguess.cm" class="d-flex align-items-center gap-1"
                   target="_blank">
                    Read Documentation
                                        ...
                                        <div class="d-flex align-items-center gap-2 justify-content-between flex-grow-1">
                                            ...
                                            @else
                                                <span class="cursor-pointer" data-bs-toggle="tooltip"
                                                      data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                                      data-bs-html="true" data-bs-delay='{"hide":1000}'
                                                      data-bs-title="{{ $key }} extension is not enabled in your server. To enable go to PHP version > extensions and select {{ translate($key) }}.">
                                                    <img src="{{ asset('assets/installation/assets/img/svg-icons/info.svg') }}" class="svg text-danger" alt="">
                        </span>
                                            @endif
                                        </div>
                                    </div>
